...
public class AccType implements Cloneable, Serializable {
	...
	*/
	...
	private static final String CAT_BAFL_ONUS_ATM_FEE_ACCT_VALUE = "BAFL_ONUS_ATM_FEE_ACCT";
	private static final String CAT_BAFL_ONUS_ATM_FEE_WLLT_VALUE = "BAFL_ONUS_ATM_FEE_WLLT";
	private static final String CAT_BAFL_ONUS_ATM_SETT_ACCT_VALUE = "ATM_ONUS_ACCT";
	private static final String CAT_BAFL_ONUS_ATM_SETT_WLLT_VALUE = "ATM_ONUS_WLLT";


	private static final String CAT_BAFL_ONUS_ATM_RECEIPT_CHRG_ACCT_VALUE = "BAFL_ONUS_ATM_RECEIPT_CHRG_ACCT";
	private static final String CAT_BAFL_ONUS_ATM_RECEIPT_CHRG_WLLT_VALUE = "BAFL_ONUS_ATM_RECEIPT_CHRG_WLLT";

	private static final String CAT_BAFL_ONUS_BALANCE_INQUIRY_CHRG_ACCT_VALUE = "BAFL_ONUS_BALANCE_INQUIRY_ACCT";
	private static final String CAT_BAFL_ONUS_BALANCE_INQUIRY_CHRG_WLLT_VALUE = "BAFL_ONUS_BALANCE_INQUIRY_WLLT";
	...
	// Asim Shahzad, Date : 6th June 2023, Tracking ID : VP-NAP-202303091
	public static final AccType CAT_BAFL_ONUS_ATM_SETT_ACCT =  new AccType(CAT_BAFL_ONUS_ATM_SETT_ACCT_VALUE);
	public static final AccType CAT_BAFL_ONUS_ATM_SETT_WLLT =  new AccType(CAT_BAFL_ONUS_ATM_SETT_WLLT_VALUE);

	// Commented By Huzaifa: 11/08/2023: FW: NAP-P5-23 ==> [ Logging email ] ==> Segregation of ATM On Us Channels Bank - UBL & BAFL
	public static final AccType CAT_BAFL_ONUS_ATM_FEE_ACCT =  new AccType(CAT_BAFL_ONUS_ATM_FEE_ACCT_VALUE);
	public static final AccType CAT_BAFL_ONUS_ATM_FEE_WLLT =  new AccType(CAT_BAFL_ONUS_ATM_FEE_WLLT_VALUE);

	public static final AccType CAT_BAFL_ONUS_ATM_RECEIPT_CHRG_ACCT =  new AccType(CAT_BAFL_ONUS_ATM_RECEIPT_CHRG_ACCT_VALUE);
	public static final AccType CAT_BAFL_ONUS_ATM_RECEIPT_CHRG_WLLT =  new AccType(CAT_BAFL_ONUS_ATM_RECEIPT_CHRG_WLLT_VALUE);

	public static final AccType CAT_BAFL_ONUS_BALANCE_INQUIRY_CHRG_ACCT =  new AccType(CAT_BAFL_ONUS_BALANCE_INQUIRY_CHRG_ACCT_VALUE);
	public static final AccType CAT_BAFL_ONUS_BALANCE_INQUIRY_CHRG_WLLT =  new AccType(CAT_BAFL_ONUS_BALANCE_INQUIRY_CHRG_WLLT_VALUE);
	// ==================================================================
