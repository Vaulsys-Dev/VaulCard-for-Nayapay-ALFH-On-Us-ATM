...
//            }
    ...
    public static WalletCMSWsEntity processCashWithDrawal(WalletCMSWsEntity wsmodel)
    {
        ...
        else
        {
            ...
            if(wsmodel.getAcqbin().equals("62710000000")) {
                return WSOperation.ExecuteOnUsCashWithDrawal(wsmodel);
            }
            else {
    ...
    public static WalletCMSWsEntity processCardBasedReversal(WalletCMSWsEntity wsmodel)
    {
        ...
        else
        {
            ...
            //Huzaifa, Date : 6th March 2024, Tranking ID : NAP-P5-23 - Segregation of ATM On Us Channels Bank - UBL & BAFL
            if(wsmodel.getAcqbin().equals("62710000000")) {
                return WSOperation.ExecuteOnUsATMCashWithdrawalReversal(wsmodel);
            }
            else {
