...
//    }
    ...
    public WalletCMSWsEntity copy() {
		...
		//Arsalan Akhter, Date:15-Sept-2021, Ticket:VP-NAP-202109151/VC-NAP-202109151(cardlastdigits parameter name should be same in all relevant calls)
        wsEntity.setCardlastdigits(this.getCardlastdigits());
		//===============================================================================================================
        wsEntity.setId(null);
        //Arsalan Akhter, Date: 07-Oct-2021, Ticket: VP-NAP-202110051 / VC-NAP-202110053(Document 4.9.1 - Notifications Update)
        ...
        wsEntity.setLimittype(this.getLimittype());
        //======================================================================================================
    ...
    @Column(name = "ISTRANSACTIONCHARGED")
 ...
 public String getOnustranxcounts() {
    ...
    @Transient
    private String responsefrommiddleware;

    @Transient
    private String servicenamefrommiddleware;

    public String getServicenamefrommiddleware() {
        return servicenamefrommiddleware;
    }

    public void setServicenamefrommiddleware(String servicenamefrommiddleware) {
        this.servicenamefrommiddleware = servicenamefrommiddleware;
    }

    public String getResponsefrommiddleware() {
        return responsefrommiddleware;
    }

    public void setResponsefrommiddleware(String responsefrommiddleware) {
        this.responsefrommiddleware = responsefrommiddleware;
    }
